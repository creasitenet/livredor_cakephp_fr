...
<head>
    <?= $this->Html->charset() ?>
	<title>Livre d'or - CakePHP 3.0
        <?= $this->fetch('title') ?>
    </title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Livre d'or sous CakePHP 3.0" />
    ...
    <?= $this->Html->css('../plugins/growl/jquery.growl.css') ?>  
...
<body>
    ...
    <div class="wrapper">	
	    ...
	    <a href="https://github.com/creasitenet/livredor_cakephp_fr" target="_blank">
    ...
    <?= $this->Html->script('../plugins/growl/jquery.growl.js') ?>
